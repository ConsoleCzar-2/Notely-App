...
/**
 * Prometheus metrics configuration for User Service
 */
...
client.collectDefaultMetrics({ register, prefix: 'user_' });
 ...
 * @param {string} operation - Operation type (get_profile, update_profile, delete_account, get_user)
 * @param {string} status - Status (success, failure)
 */
function recordUserOperation(operation, status) {
